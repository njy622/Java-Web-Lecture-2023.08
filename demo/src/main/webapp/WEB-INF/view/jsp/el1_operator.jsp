...
<body style="margin: 40px;">
	...
	<table border="1">
		...
		<tr><td>\${100}</td><td>${100}</td></tr>  <%-- 표현식을 출력하고 싶으면 \ 표시 --%>
	...
	<%-- <tr><td>\${"hello"+"안녕"}</td><td>${"hello"+"안녕"}</td></tr>  스트링 문자열 붙이기는 안됨--%>
		<tr><td>산술표현식</td><td>결과</td></tr>
		...
		<tr><td>비교연산표현식</td><td>결과</td></tr>
		<tr><td>\${20 == 10}</td><td>${20 == 10}</td></tr>
		<tr><td>\${20 eq 10}</td><td>${20 eq 10}</td></tr>
		<tr><td>\${20 ne 10}</td><td>${20 ne 10}</td></tr> <%-- ne : not equre --%>
		...
		<tr><td>빈 문자열 확인 표현식</td><td>결과</td></tr>
	...
	<h3>사례</h3>
	<ul>
		<li>파라메터 값은 ${empty param.num ? '입력하지 않음' : param.num} 입니다.</li>
